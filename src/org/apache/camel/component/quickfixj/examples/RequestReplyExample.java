...
import quickfix.fix50sp2.OrderStatusRequest;
...
public class RequestReplyExample {
    ...
    public void run() throws Exception {        
        ...
        RouteBuilder routes = new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("file:/opt/aurea/sonic/Workbench10.0/workspace/Arka1/src/org/apache/camel/component/quickfixj/examples/inprocess.cfg").
    ...
    public static class OrderStatusRequestTransformer {
        ...
        public void transform(Exchange exchange) throws FieldNotFound {
            ...
            String replySessionID = "FIX.4.4:MARKET->TRADER";
            LOG.info("Given the requestSessionID '{}' calculated the replySessionID as '{}'", requestSessionID, replySessionID);

            String orderID = exchange.getIn().getHeader("orderID", String.class);

            OrderStatusRequest prueba = new OrderStatusRequest();
            
            quickfix.fix50.OrderStatusRequest request = new quickfix.fix50.OrderStatusRequest(new ClOrdID("XYZ"), new Side(Side.BUY));
            //quickfix.fix42.OrderStatusRequest request = new quickfix.fix42.OrderStatusRequest(new ClOrdID("XYZ"), new Symbol("GOOG"), new Side(Side.BUY));
    ...
    public static class MarketOrderStatusService {
        ...
        public ExecutionReport getOrderStatus(OrderStatusRequest request) throws FieldNotFound {
            ...
            return new quickfix.fix50sp2.ExecutionReport(request.getOrderID(), 
            ...
            /*return new quickfix.fix50.ExecutionReport(request.getOrderID(), 
                new ExecID(UUID.randomUUID().toString()),
    ...
    public static class FixSessionRouter {
        public String route(@Header("sessionID") String sessionID) {
            return String.format("examples/inprocess.cfg?sessionID=%s", sessionID);
        }
    }
}
