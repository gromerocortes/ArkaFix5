...
import org.apache.camel.component.quickfixj.Support;
    ...
    public void sendMessage() throws Exception {        
        ...
        RouteBuilder routes = new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("examples/inprocess.cfg?sessionID=FIX.4.4:MARKET->TRADER").
        ...
        String marketUri = "examples/inprocess.cfg?sessionID=FIX.4.2:TRADER->MARKET";
        Producer producer = context.getEndpoint(marketUri).createProducer();
        
        Email email = Support.createEmailMessage("Example");
        Exchange exchange = producer.createExchange(ExchangePattern.InOnly);
        exchange.getIn().setBody(email);
        
        LOG.info("SimpleMessagingExample:.... : " + exchange.toString() + exchange.getIn().getBody().toString());
