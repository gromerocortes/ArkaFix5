...
public class MessagePredicate {
	...
	//private final List<Field> lista = new ArrayList<Field>();
	
    private final List<Field> headerCriteria = new ArrayList<Field>();
    private final List<Field> bodyCriteria = new ArrayList<Field>();
    ...
    private boolean evaluate(FieldMap fieldMap, List<Field> bodyCriteria2) {
        for (Field c : bodyCriteria2) {
            String value = null;
            try {
