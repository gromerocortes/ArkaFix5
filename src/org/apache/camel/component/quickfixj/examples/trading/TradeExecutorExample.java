...
public class TradeExecutorExample {
    ...
    public void sendMessage() throws Exception {        
        ...
        RouteBuilder routes = new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("examples/inprocess.cfg?sessionID=FIX.4.2:MARKET->TRADER").
                ...
                from("trade-executor:market").to("examples/inprocess.cfg");
                ...
                from("examples/inprocess.cfg?sessionID=FIX.4.2:TRADER->MARKET").
        ...
        String gatewayUri = "examples/inprocess.cfg?sessionID=FIX.4.2:TRADER->MARKET";
    ...
    private NewOrderSingle createNewOrderMessage() {
    	...
    	order.set(new ClOrdID("CLIENT_ORDER_ID"));
